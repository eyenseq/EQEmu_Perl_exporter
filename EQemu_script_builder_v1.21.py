...
def validate_blocks(blocks, plugin_registry) -> list[ValidationIssue]:
    ...
    if not ok:
        ...
        issues.append(
            ValidationIssue("warn", "Whole script: unbalanced braces.", "root")
        )
...
def generate_perl(blocks: List[Block], plugins: PluginRegistry, npc_id: Optional[int] = None) -> str:
    lines: List[str] = []
    lines.append("# Generated by EQEmu Script Builder v1.21")
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("EQEmu Script Builder v1.21")
    ...
    def refresh_diagnostics(self):
        ...
        # Debounce Perl preview regen so we don't rebuild on every keystroke
        self._perl_preview_timer.start(250)
